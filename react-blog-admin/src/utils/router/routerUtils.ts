...
const getAllRoutersMap = (routerConfig: RouteItemType[]): Map<string, any> => {
 ...
 * @returns 
 */
function deepLoopChildrenKey(children: RouteItemType[], rootKey: string, childMap: Map<string, any>): Map<string, any> {
