...
// 博客标签
const blogLableOptions = [{ label: 'React', value: 'gold' }, { label: 'VUE', value: 'lime' }, { label: 'C#', value: 'green' }, { label: '操作系统', value: 'cyan' }, {label: 'Java', value: '#A2007C'}, {label: '生活', value: '#00BFFF'}, {label: '恋爱', value: '#FFC1C1'}]
      ...
      <Space direction="vertical" size="small" style={{ display: 'flex' }}>
        ...
        <Form.Item label='文章专题: '>
          ...
          <Space direction='horizontal'>
            ...
            <Button size={btnSize} loading={loading} type="primary" htmlType="submit">发布</Button>
          </Space>
        </Form.Item>
      </Space>
      </Form>
